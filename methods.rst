...
Principal Component Analysis (PCA) is a technique for dimensionality reduction. It is used to explain the variance–covariance structure of a set of variables through linear combinations of the variables. Principal components (PCs) are variables constructed as linear combinations of the initial variables. The PCs are uncorrelated and most of the information within the initial variables is squeezed or compressed into the first PCs. The PCs represent the directions of the data that explain a maximal amount of variance and so they capture most information. Though 10-dimensional data gives you 10 PCs, PCA put maximum possible information in the first component, followed by the second component, and so forth. ...expand... In OPG, PCA is performed using the `irlba` R package which
